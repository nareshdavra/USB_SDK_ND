...
public class SerialPort {
   ...
   private SerialPort.EventThread eventThread;
   ...
   private SerialPort.EventThread getNewEventThread() {
      return (SerialPort.EventThread)(SerialNativeInterface.getOsType() != 0 && SerialNativeInterface.getOsType() != 2 && SerialNativeInterface.getOsType() != 3?new SerialPort.EventThread((SerialPort.NamelessClass621400143)null):new SerialPort.LinuxEventThread());
   }
   ...
   // $FF: synthetic class
   static class NamelessClass621400143 {
   }

   private class LinuxEventThread extends SerialPort.EventThread {
      ...
      public LinuxEventThread() {
         super((SerialPort.NamelessClass621400143)null);
         int[][] var2 = SerialPort.this.waitEvents();
         ...
         for(int var3 = 0; var3 < var2.length; ++var3) {
            ...
            case 256:
               ...
               break;
            case 512:
               this.interruptBreak = var5;
               break;
            case 1024:
               this.interruptTX = var5;
               break;
            case 2048:
               this.interruptFrame = var5;
               break;
            case 4096:
               this.interruptOverrun = var5;
               break;
            case 8192:
               this.interruptParity = var5;
            }
         }
      ...
      public void run() {
         while(!super.threadTerminated) {
            int[][] var1 = SerialPort.this.waitEvents();
            int var2 = SerialPort.this.getLinuxMask();
            boolean var3 = false;
            int var4 = 0;

            for(int var5 = 0; var5 < var1.length; ++var5) {
               boolean var6 = false;
               int var7 = var1[var5][0];
               int var8 = var1[var5][1];
               if(var7 > 0 && !super.threadTerminated) {
                  switch(var7) {
                  case 1:
                     if((var2 & 1) == 1 && var8 > 0) {
                        var6 = true;
                  ...
                  case 256:
                     ...
                     break;
                  case 512:
                     if(var8 != this.interruptBreak) {
                        this.interruptBreak = var8;
                        if((var2 & 64) == 64) {
                           var7 = 64;
                           var8 = 0;
                           var6 = true;
                     ...
                     break;
                  case 1024:
                     if(var8 != this.interruptTX) {
                        this.interruptTX = var8;
                        var3 = true;
                     }
                     break;
                  case 2048:
                     if(var8 != this.interruptFrame) {
                        this.interruptFrame = var8;
                        var4 |= 8;
                     }
                     break;
                  case 4096:
                     if(var8 != this.interruptOverrun) {
                        this.interruptOverrun = var8;
                        var4 |= 2;
                     }
                     break;
                  case 8192:
                     if(var8 != this.interruptParity) {
                        this.interruptParity = var8;
                        var4 |= 4;
                     }

                     if((var2 & 128) == 128 && var4 != 0) {
                        var7 = 128;
                        var8 = var4;
                        var6 = true;
                     }
                  ...
                  if(var6) {
                     SerialPort.this.eventListener.serialEvent(new SerialPortEvent(SerialPort.this.portName, var7, var8));
                  }
               }
            }
   ...
   private class EventThread extends Thread {
      ...
      // $FF: synthetic method
      EventThread(SerialPort.NamelessClass621400143 x1) {
         this();
      }
   }
}
